  ...
  return (
    <>
      ...
      <div
        ...
        className={`absolute right-4 z-[1600] flex flex-col gap-1.5 items-end transition-opacity duration-300 motion-reduce:transition-none ${show ? "opacity-100" : "opacity-0 pointer-events-none"}`}
